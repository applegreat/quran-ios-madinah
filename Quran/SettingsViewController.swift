...
//        audioDownloadsDataSource.items = [Setting(name: lAndroid("audio_manager"), image: #imageLiteral(resourceName: "download-25"), zeroInset: true)]
    ...
    func presentShareApp() {
        let url = unwrap(URL(string: "https://play.google.com/store/apps/details?id=b.owtech.islamic.apps.quran.offline"))
        let appName = "Quran Madina - القرآن الكريم مصحف المدينة المنورة"
